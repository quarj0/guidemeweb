const s = [
  ...
  },
  {
    ...
    description: "Python Network Programming. Let's learn how to create network applications using Python.",

    link: "/network-programming",
  },
  {
    title: "Python GUI Programming",
    description: "Python GUI Programming. Let's learn how to create GUI applications using Python.",

    link: "/python-gui-programming",
  },
  {
    title: "Python Game Development ",
    description: "Python Game Development. Let's learn how to create games using Python.",
  ...
  {
    title: "JavaScript",
    description: "JavaScritp is a programming language that adds interactivity to your website. Learn how to make web pages interactive and provide online programs and games.",
    link: "/javascript",
  },
  ...
  {
    title: "Kali Linux ",
    description: "Kali Linux, a Debian-based Linux distribution aimed at advanced Penetration Testing and Security Auditing.",
  ...
  {
    title: "HTML ",
    description: "HTML is the standard markup language for creating Web pages. With HTML you can create your own Website.",
    link: "/html",
  },
  {
    title: "CSS ",
  ...
  {
    title: "React ",
    description: "React is a JavaScript library for building very fast user interfaces.",
    link: "/react",
  },
  {
    title: "Git ",
