      ...
      contents = (
        <>
          <section>
            ...
            <p>
              The <code>else</code> keyword catches anything which isn't caught
            ...
            <p>
              Short Hand If <code>if</code> statement One line if statement:
            </p>
            <pre>
              <code>if a &gt; b: print("a is greater than b")</code>
            </pre>
            <p>
              One line if else statement: <code>a = 2 b = 330</code>
            </p>
            <pre>
            ...
            <p>
              ...
              else statement, with 3 conditions: <code>a = 330 b = 330</code>
            </p>
            <pre>
              <code>
                print("A") if a &gt; b else print("=") if a == b else print("B")
      ...
      contents = (
        <>
          <section>
            ...
            <p>
              <code>break</code> statement We can stop the loop even if the
            ...
            <p>
              <code>continue</code> statement With the <code>continue</code>
            ...
            <p>
              <code>else</code> statement With the <code>else</code> statement
      ...
      contents = (
        <>
          <section>
            ...
            <p>
              With the <code>for</code> loop we can execute a set of statements,
            ...
            <p>
              The <code>for</code> loop does not require an indexing variable to
              set beforehand.
            </p>
            <p>
              <code>break</code> statement With the <code>break</code> statement
            ...
            <p>
              <code>range()</code> function To loop through a set of code a
              specified number of times, we can use the <code>range()</code>
              function, The <code>range()</code> function returns a sequence of
              numbers, starting from 0 by default, and increments by 1 (by
              default), and ends at a specified number.
            </p>
            <pre>
              <code>for x in range(6): print(x)</code>
            </pre>
            <p>
              The <code>range()</code> function defaults to 0 as a starting
              value, however it is possible to specify the starting value by
              adding a parameter: <code>range(2, 6)</code>, which means values
              from 2 to 6 (but not including 6):
            </p>
            <pre>
              <code>for x in range(2, 6): print(x)</code>
            </pre>
            <p>
              The <code>range()</code> function defaults to increment the
              sequence by 1, however it is possible to specify the increment
              value by adding a third parameter: <code>range(2, 30, 3)</code>:
            </p>
            <pre>
              <code>for x in range(2, 30, 3): print(x)</code>
            </pre>
            <p>
              <code>else</code> in <code>for</code> loop The <code>else</code>
              keyword in a <code>for</code> loop specifies a block of code to be
            ...
            <p>
              Note: The <code>else</code> block will NOT be executed if the loop
              is stopped by a <code>break</code> statement.
            </p>
            <p>
              <code>Nested Loops</code> A nested loop is a loop inside a loop.
            </p>
            <p>
