            ...
            <div className="landing-page-tutorials">
              ...
              <div className="tutorial-card">
                ...
                <div className="tutorial-card-content">
                  ...
                  <p>
                    Learn how to visualize data using Python programming
                    language. A great way to learn data science.
                  </p>
                  <Link
                    to="/python-visualization"
              ...
              <div className="tutorial-card">
                ...
                <div className="tutorial-card-content">
                  <h3>Cryptography</h3>
                  <p>
                    Learn how to encrypt and decrypt data using cryptography.
